...
export default function AlertBottomSheet({
  ...
  const schema = yup
    .object({
      note: props.noteIsRequired
        ? yup.string().required().label(t('note'))
        : yup.string().optional(),
        ...
        <FormProvider {...method}>
          <View
            ...
            <Stack
              ...
              {props.imageNode && (
                <View style={{paddingBottom: 16}}>{props.imageNode}</View>
              )}
              {props.title && (
                <Typography type={'title2'} style={{textAlign: 'center'}}>
                  {props.title}
                </Typography>
              )}
              {props.description && (
            ...
            {props.withImage && (
              <>
                <Typography
                  type="title3"
                  style={{color: colors.neutral.neutral_100, marginTop: 8}}>
                  {t('item_photo')}
                </Typography>
              ...
              {props.buttonSecondary && (
                <View style={{flex: 1}}>
                  <Button
                    ...
                    {props.buttonSecondaryTitle ?? t('cancel')}
                  </Button>
                </View>
              )}
              <Button
                ...
                {props.buttonPrimaryTitle ?? t('back')}
              </Button>
            </Stack>
          </View>
        </FormProvider>
